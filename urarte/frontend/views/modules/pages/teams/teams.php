...
<?php if ($pageTeams[0]->status_page != 0): ?>
    ...
    <?php if ($dataTeams != "Not Found"): ?>
        ...
        <section class="promo-primary preloadFalse">
            ...
            <div class="promo-primary__description"> <span><?php echo TemplateController::capitalize(strtolower($pageTeams[0]->word_page)) ?></span></div>
            <div class="container">
                <div class="row">
                    <div class="col-auto">
                        <div class="align-container">
                            <div class="align-container__item"><span class="promo-primary__pre-title"><?php echo $organization[0]->name_organization ?></span>
                                <h1 class="promo-primary__title"><span><?php echo TemplateController::capitalize(strtolower($pageTeams[0]->name_page)) ?></span></h1>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            echo '<div class="col-sm-6 col-lg-4 col-xl-3">
                                    ...
                                    <div class="team-item team-item--primary">
                                        ...
                                        <div class="team-item__description">
                                            <div class="team-item__name"><a style="text-decoration:none" href="'.$path.$value->route_team.'">'.TemplateController::capitalize(strtolower($value->name_team)).'</a></div>
                                            <div class="team-item__position">'.TemplateController::capitalize(strtolower($value->position_team)).'</div>
                                        </div>
                                    </div>
                                    <!-- item end-->
                                </div>';
