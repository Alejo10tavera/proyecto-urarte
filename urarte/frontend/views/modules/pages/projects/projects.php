...
<?php if ($pageProjects[0]->status_page != 0): ?>
    ...
    <main class="main">
        ...
        <section class="promo-primary">
            ...
            <div class="promo-primary__description"> <span><?php echo $pageProjects[0]->word_page ?></span></div>
            <div class="container">
                <div class="row">
                    <div class="col-auto">
                        <div class="align-container">
                            <div class="align-container__item"><span class="promo-primary__pre-title"><?php echo $organization[0]->name_organization ?></span>
                                <h1 class="promo-primary__title"><span><?php echo $pageProjects[0]->name_page ?></span></h1>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <li class="shop-filter__item shop-filter__item--active"><span>Ordenar</span>
                                <ul class="shop-filter__sub-list">
                                    <?php
                                        ...
                                        echo '<li><a href="'.$path.$urlParams[0].'/'.$routesArray[2].'/recientes">Más reciente</a></li>
                                              <li><a href="'.$path.$urlParams[0].'/'.$routesArray[2].'/antiguos">Más antiguo</a></li>';
                    ...
                    <?php 
                        ...
                        if($dataProjects == "Not Found"){
                            ...
                            if($routesArray[1] != "projects"){
                                ...
                                $url = CurlController::api()."categories?id=".$dataProjects[0]->id_category."&nameId=id_category&linkTo_=status_category&equalTo_=1";       
                                $method = "PUT";
                                    ...
                                    <div class="causes-item causes-item--primary">
                                        <div class="causes-item__body">
                                            <div class="causes-item__top">
                                                <h6 class="causes-item__title"> <a href="'.$path.$value->route_project.'">'.$value->name_project.'</a></h6>
                                                <p>'.$value->headline_project.'</p>
                                            </div>
                                            <div class="causes-item__img">
                                                <div class="causes-item__badge" style="background-color: '.$value->color_category.'">'.$value->name_category.'</div><img class="img--bg" src="'.$backoffice.'views/img/projects/'.$value->id_category.'/logo/'.$value->logo_project.'" alt="'.$value->name_project.'"/>
                                            </div>
