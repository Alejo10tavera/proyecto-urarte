...
class PostController{
	...
	public function postRegister($table, $data){
		...
		if(isset($data["password_user"]) && $data["password_user"] != null){
			...
			if($response == "The process was successful"){
				...
				$user = GetModel::getFilterData($table, "email_user", $data["email_user"], "status_user", 1, null, null, null, null, "*");
	...
	public function postLogin($table, $data){
		...
		$response = GetModel::getFilterData($table, "email_user", $data["email_user"], "status_user", 1, null, null, null, null, "*");
